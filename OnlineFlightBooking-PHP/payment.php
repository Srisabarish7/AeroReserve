          ...
          <h1 class="text-center text-light">PAY INVOICE</h1>
            ...
            <div class="icon-container">
              ...
              <i class="fa fa-cc-discover fa-3x" style="color:orange;"></i>
               ...
               <i class="fa fa-cc-Google-pay fa-3x" style="color:blue;"></i>
               <i class="fab fa-google-pay fa-3x" style="color:blue;"></i>
            </div>
            <hr>
            <form action="includes/payment.inc.php" method="post" 
                ...
                <button id="google-pay-button" class="btn btn-lg btn-primary btn-block">
                     <i class="fab fa-google-pay"></i>&nbsp;
                     <a href="gpay.php" class="button">PAY</a>
                </button>    
            </form>
                </div>
            </div>
