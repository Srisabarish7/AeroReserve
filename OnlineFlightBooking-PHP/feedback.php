...
<div class="container mb-4">
  <h1> <i class="far fa-comment"></i> FEEDBACK FORM</h1>
      ...
      <div class="row justify-content-center">  
          ...
          <div class="col-12 mt-4">
            <div class="form-group">         
              <label for="exampleFormControlTextarea1">How is your Travel journey with us?</label>     
      ...
      <div class="row">
        <div class="col text-center">
          <button name="feed_but" type="submit" 
            ...
            <i class="fa fa-lg fa-arrow-right">Submit</i>  
            </div>
          </button>
        </div>
      </div>
