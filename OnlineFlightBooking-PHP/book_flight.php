  ...
  color: #424242;
    ...
    <main>
        <?php if(isset($_POST['search_but'])) { 
            ...
            $ret_date = " ";
           if (isset($flight_details['ret_date'])) {
            $return_date = $flight_details['ret_date'];
            // Now you can use $return_date safely
        } else {
            // Handle the case when 'ret_date' key is not present in the array
        }
