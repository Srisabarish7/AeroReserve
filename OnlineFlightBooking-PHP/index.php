...
body {
	background-image:url("https://wallpapercave.com/dwp2x/wp11828145.jpg");
...
<link rel="stylesheet" type="text/css"
	...
	<div class="main-agileinfo">
		<h1 class="text-light brand mt-2">
			<img src="assets\images\Deccan-Pvt.-Ltd.-Logo-03.png" 
				height="70px" width="205px" alt="">				
		SIMPLY FLY</h1>
		<div class="sap_tabs">			
				...
				<div class="resp-tabs-container">
					<div class="tab-1 resp-tab-content roundtrip">
						<form action="book_flight.php" method="post">
							...
							<div class="date">
								<div class="depart">
									<h3 style="color: rgba(255, 255, 255, 0.767);">Departure</h3>
...
.card img{
  ...
  transition: all .25s ease;
	...
	<footer class="mt-5">
	<em><h5 class="text-dark text-center p-5 brand mt-2">
				<img src="assets\images\Deccan-Pvt.-Ltd.-Logo-03.png" 
					height="40px" width="100px" alt="">				
			SIMPLY FLY</h5></em>
